...
# ====== 全局可配置参数（可直接在此处修改） ======
USER_NAME = "gtntoo"         # 用户名
UUID = "a91b59b6-ade4-497d-b4e9-88d184c20488"                     # UUID，留空则自动生成
PORT = 48888                   # Vmess端口，留空或0则自动生成
DOMAIN = "cdn.z1000.dpdns.org"                   # 域名，留空则自动获取
CF_TOKEN = "eyJhIjoiZjRiNjZiMWQ1MTAxMmI3ZThlMTU1OTU5ZGQ3NmNhMDAiLCJ0IjoiMzMxMTg2NjgtMWEzYi00MzcyLWIyNTctMjdmMDZlN2E0YzIxIiwicyI6IllURmlZakkyWVRNdE16Qm1NUzAwTldVeUxXSmxNemN0TmpJNE5XSmxOMlZpTW1aaiJ9"                 # Cloudflare Token，留空则用Quick Tunnel
# =========================================
